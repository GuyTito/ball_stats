              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="date_played" type="date" class="form-control @error('date_played') is-invalid @enderror"
                    name="date_played" value="{{ old('date_played', Carbon\Carbon::now()->toDateString()) }}" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="home_team_score" type="number" min="0" step="1" pattern="\d+"
                    value="{{ old('home_team_score', 0) }}" class="form-control score" name="home_team_score">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="away_team_score" type="number" min="0" step="1" pattern="\d+"
                    value="{{ old('away_team_score', 0) }}" class="form-control score" name="away_team_score">
                </div>
              </div>

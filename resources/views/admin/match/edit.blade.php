                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('match.update', $match) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="date_played" type="date"
                                        ...
                                        value="{{ old('date_played', Carbon\Carbon::parse($match->date_played)->toDateString()) }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="home_team_score" type="number" min="0" step="1" pattern="\d+" value="{{ old('home_team_score', $match->home_team_score) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="away_team_score" type="number" min="0" step="1" pattern="\d+" value="{{ old('away_team_score', $match->away_team_score) }}"
                            ...
                            @forelse ($match_goals as $match_goal)
                                ...
                                @foreach ($match_goal as $name => $player)
                                    <div class="form-group row" id="scorerDiv-{{$id}}" data-id={{$id}} >
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="typeahead get_players" name="scorers[]" id="scorer_{{$id}}" value="{{$name}}" size="17">
                                            <label class="mx-2">Goals: </label><input type="number" min="1" step="1" value="{{$player[1]}}" name="goals[]" id="goals_{{$id}}" style="width: 3rem">
                            ...
                            @forelse ($match_assists as $match_assist)
                                ...
                                @foreach ($match_assist as $name => $player)
                                    <div class="form-group row" id="assistorDiv-{{$id}}" data-id={{$id}} >
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="typeahead get_players" name="assistors[]" id="assistor_{{$id}}" value="{{$name}}" size="16">
                                            <label class="mx-2">Assists: </label><input type="number" min="1" step="1" value="{{$player[1]}}" name="assists[]" id="assists_{{$id}}" style="width: 3rem">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="venue" type="text" class="form-control @error('venue') is-invalid @enderror"
                                        name="venue" value="{{ old('venue', $match->venue) }}" required>
